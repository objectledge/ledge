 ...
 * Revision 1.2  2003/04/01 15:06:38  zwierzem
 * Fixes for popup menu positioning.
 *
 * Revision 1.1  2002/10/28 13:09:25  zwierzem
 * Updated for use with ScriptLoader.js.
 *
 * Revision 1.1  2002/10/25 11:05:22  zwierzem
...
function cssStyleSetPageX(x)
{
  ...
  if (elm.offsetParent)
  {
    elmstyle = new xbStyle(elm.offsetParent);
    xParent = elmstyle.getPageX();
  }
  else if (elm && typeof(elm.offsetLeft) == 'number')
  {
    while (elm)
    {
...
function cssStyleSetPageY(y)
{
  ...
  {
    elmstyle = new xbStyle(elm.offsetParent);
    yParent = elmstyle.getPageY();
  }
  else if (elm && typeof(elm.offsetTop) == 'number')
  {
    while (elm)
    {
