...
public class ServerApiRestrictions
{
        ...
        String httpAuthorizationHeader, String remoteAddr, boolean secure)
    {
        ...
        AutorizationStatus status = AutorizationStatus.UNDEFINED;
        ...
        String secret, String remoteAddr, boolean secure, String path, RequestMethod method)
    {
        ...
        {
            return AutorizationStatus.UNDEFINED;
        }
                            ...
                            try
                            {
                                ...
                                for(CIDRBlock addressRange : apiRestriction.getAddressRanges())
                                {
                                    try
                                    {
                                        ...
                                        {
                                            log.debug("ACCEPTED API call from " + remoteAddr);
                                            return AutorizationStatus.AUTHORIZED;
                                        }
                                    }
                                    catch(IllegalArgumentException e)
                                    {
        ...
        return AutorizationStatus.UNAUTHORIZED;
    }
}
