...
{
    var controlType = getType(formName, controlName);
 ...
 */
function setValue(formName, controlName, value)
{
    var controlType = getType(formName, controlName);
    var control = document.forms[formName].elements[controlName];
 ...
 */
function getType (formName, controlName)
{
