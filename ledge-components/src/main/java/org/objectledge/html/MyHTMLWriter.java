...
public class MyHTMLWriter extends XMLWriter {
    ...
    public MyHTMLWriter(Writer writer) {
        super( writer, defaultHtmlFormat );
    }

    public MyHTMLWriter(Writer writer, OutputFormat format) {
        super( writer, format );
    }

    public MyHTMLWriter() throws UnsupportedEncodingException {
        super( defaultHtmlFormat );
    }

    public MyHTMLWriter(OutputFormat format) throws UnsupportedEncodingException {
        super( format );
    }

    public MyHTMLWriter(OutputStream out) throws UnsupportedEncodingException {
        super( out, defaultHtmlFormat );
    }

    public MyHTMLWriter(OutputStream out, OutputFormat format) throws UnsupportedEncodingException {
        super( out, format );
    }
    ...
    protected static final HashSet defaultOmitElementCloseSet;

    static {
        //If you change this list, update the javadoc in getOmitElementCloseSet().
        defaultOmitElementCloseSet = new HashSet();
        defaultOmitElementCloseSet.add( "AREA" );
        defaultOmitElementCloseSet.add( "BASE" );
        defaultOmitElementCloseSet.add( "BR" );
        defaultOmitElementCloseSet.add( "COL" );
        defaultOmitElementCloseSet.add( "HR" );
        defaultOmitElementCloseSet.add( "IMG" );
        defaultOmitElementCloseSet.add( "INPUT" );
        defaultOmitElementCloseSet.add( "LINK" );
        defaultOmitElementCloseSet.add( "META" );
        defaultOmitElementCloseSet.add( "P" );
        defaultOmitElementCloseSet.add( "PARAM" );
    }
    /** Used to store the qualified element names which
      * should have no close element tag
      */
    private HashSet omitElementCloseSet = defaultOmitElementCloseSet; 
    ...
    protected boolean omitElementClose( String qualifiedName ) {
        return (omitElementCloseSet != null) && (omitElementCloseSet.contains(qualifiedName.toUpperCase()));
    }
    ...
    public Set getOmitElementCloseSet(){
        ...
        {
            return (Set)(omitElementCloseSet.clone());
        }
        else
        {
            return null;
