...
import pl.caltha.encodings.MappingEntry;

/**
 * HTMLEntity encoder.
 *
 * @author    <a href="mailto:zwierzem@ngo.pl">Damian Gajda</a>
 * @version   $Id: CharEncoderHTMLEntity.java,v 1.1 2005-01-19 06:55:15 pablo Exp $
 */
...
null,null,null,null,null,null,null,null
    ...
    public int entityCode(String name)
    {
        ...
        MappingEntry ent = (MappingEntry)entitiesByName.get(key);
        if(ent != null)
        {
            return ent.unicodeCode;
        }
